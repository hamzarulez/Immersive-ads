        ...
        <div className="bg-neutral-800/50 border border-neutral-700/50 rounded-xl p-6 flex flex-col">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-xl font-bold text-green-400">${project.contract_value.toLocaleString()}</p>
                </div>
    ...
    return (
        <div className="bg-black text-white min-h-screen flex">
            ...
            <main className="flex-1 p-8 overflow-y-auto">
                ...
                {/* We'll add tabs here in the future, for now we list them by category */}
                <section>
