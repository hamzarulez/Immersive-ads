...
export default function AnalyticsPage() {
    ...
    if (loading) {
        return <DashboardShell><p className="text-neutral-500">Loading analytics...</p></DashboardShell>;
    }

    if (error) {
        return <DashboardShell><p className="text-red-500">Error: {error}</p></DashboardShell>;
    }

    // --- NEW LOGIC FOR DISPLAYING THE RATING ---
        ...
        <DashboardShell>
            <div className="space-y-8">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <KpiCard title="Completed Projects" value={kpiData?.projects || 0} icon={Medal} />
...
// Helper component to avoid repeating the sidebar/header layout
